...
export declare const GITHUB_AUTHORIZE_URL = "https://github.com/login/oauth/authorize";
...
export declare function isDevicePending(r: DeviceTokenResponse): r is DeviceTokenPending;
